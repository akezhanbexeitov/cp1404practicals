...
def main():
    ...
    # list of all of the full_names in lowercase format
    ...
    # list of only the numbers that are greater than 9 from the numbers
    double_figures = [number for number in numbers if number > 9]
    print(double_figures)
